...
export const getStaticProps: GetStaticProps<AboutProps> = async () => ({
  props: {
    description:
      "Welcome to X, a destination for the fans and people who want to know Falcom's works! This website is created to celebrate and share our love for all things Falcom.",
    // cspell:disable
    contributors: [
      {
        name: 'Franz DC',
  ...
  <MainLayout title='About' description={description}>
    ...
    <Box component='section' sx={{ mb: 4 }}>
      ...
      <Typography>
        ...
        by providing more information about the staff and/or their works, or by
        doing guess contributions.
      </Typography>
      {/* cspell:enable */}
    </Box>
    <Box component='section'>
      ...
      <Typography gutterBottom>
        All copyrighted content, trademarks, and intellectual property featured
